...
# License: MIT
# Pre-requisites: run both 02-dataclean and 01-downloaddata and check there is such file in analysisdata file.
...
ggplot(pole_long, aes(x = Time, y = q3sec, color = Qualifying)) +
  ...
  labs(
    title = "Qualifying Times vs. Pole Position Times",
