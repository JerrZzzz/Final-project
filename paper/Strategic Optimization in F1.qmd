...
kable(p11, caption = "Q1, Q2 11th Fastest Driver Lap Time in Seconds", align = 'c')
...
kable(explain_pole, caption = "Q1, Q2, and Q3 fastest driver Lap Time in Seconds", align = 'c')
...
ggplot(data_for_plot, aes(x = Round, y = Difference, fill = Round)) +
  ...
  labs(
    title = "Difference of Median Lap Times in Q2 and Q3 Relative to Q1",
    x = "Qualifying Round",
...
#| eval: true
#| label: tbl-model1
#| tbl-cap: "Model Summary of Elimination Time for Q2"
#| warning: false
...
#| eval: true
#| label: tbl-model2
#| tbl-cap: "Model Summary of Pole Position Time"
#| warning: false
...
#| fig-cap: "Percentage of Race Wins For Each Qualifying Position"
#| warning: false
...
#| fig-cap: "Examining how model on Elimination time for Q2 fits"
...
#| fig-cap: "Examining how model on Pole position lap time fits"
